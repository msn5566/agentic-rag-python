...
The unresolved details MUST also be emitted as the same JSON object shape in both places so the record is machine-readable and easy to compare between the PR and issue.

Canonical JSON shape:
```json
{
  "snykId": "SNYK-JAVA-XXXX",
  "cve": "CVE-YYYY-NNNN",
  ...
  "fixedIn": "1.2.8",
  "fromPath": ["root-app", "starter-a", "example-lib"],
  "reasonCode": "FIX_REQUIRES_CODE_CHANGE",
  "reasonDetail": "Upgrade requires a major API change in the consuming library, so it was not applied automatically."
}
```
...
[
  {
    ...
    "afterVersion": "<current-or-final>",
    "severity": "<severity>",
    "dependencyType": "<direct/transitive>",
    "fixedIn": "<version-or-none>",
    "fromPath": ["<root>", "<parent>", "<package>"],
    "reasonCode": "<REASON_CODE>",
    "reasonDetail": "<concrete one-line reason>"
  }
]
```
